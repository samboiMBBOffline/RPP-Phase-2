...
if (GlobalVariable.type == 'soleR') {
    ...
    Mobile.takeScreenshot('Screenshot/Approve/1.png')
    ...
    if (A.substring(0, 8) == 'Pay from') {
        ...
        while (A.substring(0, 8) != 'Pay from') {
            if (Mobile.verifyElementExist(fo('Auto Billing/IncomingNo', [('No') : 2]), 0, FailureHandling.OPTIONAL)) {
                ...
                Mobile.swipe(Mobile.getDeviceWidth() / 2, Mobile.getDeviceHeight() * 0.9, Mobile.getDeviceWidth() / 2, Mobile.getDeviceHeight() * 
                    0.1)
    ...
    'youve received...'
    Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('TestData').getValue(5, 19)]), 0), ft('TestData').getValue(
            5, 19))
    ...
    'Approve Now'
    Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('TestData').getValue(4, 30)]), 0), ft('TestData').getValue(
            4, 30))

    Mobile.tap(fo('Text', [('Verify') : ft('TestData').getValue(4, 30)]), 0)

    'Confirmation'
    Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('TestData').getValue(4, 31)]), 0), ft('TestData').getValue(
            4, 31))
    ...
    'Frequency compare'
    Mobile.verifyEqual(Mobile.getText(fo('Auto Billing/Following2ndText', [('Verify') : ft('TestData').getValue(4, 27)]), 
            0), Freq)
    ...
    'LPT Compare'
    Mobile.verifyEqual(Mobile.getText(fo('Auto Billing/Following2ndText', [('Verify') : ft('TestData').getValue(4, 28)]), 
            0), LPT)
    ...
    'inv no'
    Mobile.verifyEqual(Mobile.getText(fo('FollowingText1', [('Verify') : ft('TestData').getValue(4, 21)]), 0), ft('TestData').getValue(
            4, 21))
    ...
    if (Mobile.verifyElementExist(fo('Text', [('Verify') : 'Secure2u Authorisation']), 0, FailureHandling.OPTIONAL)) {
        ...
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 1)]), 0), ft('Approval').getValue(
                3, 1))

        'Account to receive payment'
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 2)]), 0), ft('Approval').getValue(
                3, 2))
        ...
        'From'
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 3)]), 0), ft('Approval').getValue(
                3, 3))
        ...
        'Recipient ref'
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 4)]), 0), ft('Approval').getValue(
                3, 4))
        ...
        'Date Time'
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 5)]), 0), ft('Approval').getValue(
                3, 5))
        ...
        'One Time Password'
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(1, 6)]), 0), ft('Approval').getValue(
                1, 6))
    ...
    if (ft('Approval').getValue(2, 2) == 'Y') {
        ...
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 7)]), 0), ft('Approval').getValue(
                3, 7))

        if (Mobile.verifyElementExist(fo('Text', [('Verify') : ft('Approval').getValue(3, 8)]), 3, FailureHandling.OPTIONAL)) {
            Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 8)]), 0), ft('Approval').getValue(
                    3, 8))
        ...
        'Ref ID'
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 9)]), 0), ft('Approval').getValue(
                3, 9))

        RefIDFail = Mobile.getText(fo('FollowingText1', [('Verify') : ft('Approval').getValue(3, 9)]), 0)

        'Date & Time'
        Mobile.verifyEqual(Mobile.getText(fo('Text', [('Verify') : ft('Approval').getValue(3, 10)]), 0), ft('Approval').getValue(
                3, 10))
